...
import logo from "../../assets/img/series/logo.png"; // Logo de l'application
import bgImage from "../../assets/img/bg.jpg"; // Image de fond
import { loginUser } from "../../redux/apiCalls/authApiCall"; // Appel API pour la connexion
